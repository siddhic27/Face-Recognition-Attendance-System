...
class Student:
    def __init__(self,root):
        ...
        #first img
        img=Image.open(r"C:\Users\siddh\Desktop\final\project images\student1.jpg")
        ...
        #second img
        img1=Image.open(r"C:\Users\siddh\Desktop\final\project images\student2.jpg")
        ...
        #third img
        img2=Image.open(r"C:\Users\siddh\Desktop\final\project images\clg.jpg")
        ...
        main_frame.place(x=20,y=55,width=1500,height=660)
        ...
        img_left=Image.open(r"C:\Users\siddh\Desktop\final\project images\girl.jpeg")
        ...
        division_combo["values"]=("A","B","C","D","E")
        ...
        img_right=Image.open(r"C:\Users\siddh\Desktop\final\project images\right.jpg")
        ...
        self.student_table=ttk.Treeview(table_frame,column=("dep","course","year","sem","std_id","std_name","div","roll","gender","dob","email","phone","address","teacher","photosample"),xscrollcommand=scroll_x.set,yscrollcommand=scroll_y.set)
        ...
        if self.var_dep.get()=="select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",user="root",password="123456",database="face_recognition")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set dep=%s,course=%s,year=%s,sem=%s,std_name=%s,div=%s,roll=%s,gender=%s,dob=%s,email=%s,phone=%s,address=%s,teacher=%s,photosample=%s where std_id=%d",(
                                                                                                                                                                                 self.var_dep.get(),
                                                                                                                                                                                 self.var_course.get(),
                                                                                                                                                                                 self.var_year.get(),
                                                                                                                                                                                 self.var_sem.get(),
