...
class Face_detector:
    def __init__(self,root):
        ...
        title_lbl=Label(self.root,text="Face Detector",font=("times new roman",35,"bold"),bg="white",fg="dodger blue")
        title_lbl.place(x=0,y=0,width=1530,height=45)


        img_top=Image.open(r"C:\Users\siddh\Desktop\final\project images\face_detector1.jpg")
        ...
        img_bottom=Image.open(r"C:\Users\siddh\Desktop\final\project images\detector.jpg")
        ...
        b1_1=Button(f_lbl,text="Face Recognition",cursor="hand2",font=("times new roman",18,"bold"),bg="dodger blue",fg="white")
        b1_1.place(x=365,y=620,width=200,height=40)

    #attendance 
    def mark_attendance(self,i,r,n,d):
        with open("siddhi.csv","r+",newline="\n") as f:
    ...
    def face_recog(self):
        ...
        while True:
            ...
            cv2.imshow("Welcome ti Face Recognition",img)
